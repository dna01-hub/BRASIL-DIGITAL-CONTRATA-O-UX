  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-bg-deep/85 backdrop-blur-[20px] saturate-[1.6] border-b border-text-primary/5 py-3'
          : 'bg-transparent py-5'
      }`}
    >
      <div className="max-w-7xl mx-auto px-5 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#planos" className="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Planos</a>
          <a href="#promocoes" className="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Promoções</a>
          <a href="#diferenciais" className="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Diferenciais</a>
          <a href="#contato" className="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Contato</a>
        </nav>
        ...
        <div className="hidden md:flex items-center gap-4">
          <button 
            onClick={toggleTheme}
            className="p-2 rounded-full bg-text-primary/5 border border-text-primary/10 text-text-secondary hover:text-text-primary transition-colors"
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-bg-deep/95 backdrop-blur-xl border-b border-text-primary/5 shadow-2xl">
