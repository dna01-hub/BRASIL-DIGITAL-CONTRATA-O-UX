        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {badges.map((badge, index) => (
            <motion.div
              ...
              className="flex items-center justify-start md:justify-center gap-3 text-text-secondary hover:text-text-primary transition-colors group"
            >
              ...
              <span className="text-sm font-bold tracking-wide text-left leading-tight">{badge.text}</span>
            </motion.div>
          ))}
        </div>
      </div>
